# Operational Failure-Mode Analysis - modeling_tracks_20260318T230604Z
...
- residual_elastic_net_global: MAE_macro=6.655, RMSE_macro=16.761
- panel_hist_gbm: MAE_macro=6.911, RMSE_macro=15.478
- ar_tweedie_global: MAE_macro=7.569, RMSE_macro=17.802
- conservative_stack: MAE_macro=9.765, RMSE_macro=22.495
- residual_random_forest: MAE_macro=19.036, RMSE_macro=46.677
- residual_hist_gbm: MAE_macro=27.183, RMSE_macro=69.258
...
- residual_elastic_net_global: MAE_macro=12.203, RMSE_macro=22.851
- ar_tweedie_global: MAE_macro=13.440, RMSE_macro=22.738
- conservative_stack: MAE_macro=20.606, RMSE_macro=28.961
- panel_hist_gbm: MAE_macro=24.645, RMSE_macro=32.884
- residual_random_forest: MAE_macro=46.724, RMSE_macro=53.262
- residual_hist_gbm: MAE_macro=54.539, RMSE_macro=69.265
...
- `1_5` best model: panel_hist_gbm (MAE=11.911, bias=1.765, mean_pred=19.508, mean_y=21.273)
...
- Horizon 4 best model under zero-origin starts: conservative_stack (MAE=0.631, mean_pred=9.369, mean_y=10.000)
